...
public class DemoMainActivity extends GvrActivity implements GvrView.StereoRenderer {
    ...
    private static final String LASER_SOUND_FILE = "laser.mp3";
    ...
    public void onCardboardTrigger() {
        ...
        successSourceId = gvrAudioEngine.createStereoSound(LASER_SOUND_FILE);
    ...
    protected void hideObject() {
        ...
        successSourceId = gvrAudioEngine.createStereoSound(EXPLOSION_SOUND_FILE);
        gvrAudioEngine.playSound(successSourceId, false /* looping disabled */);
        updateModelPosition();
    }
